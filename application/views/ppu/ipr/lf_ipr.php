<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#btn_cari').click(function () {
            ...
            $.post('<?php echo base_url() ?>c_ppu/tdp/setSession', data, function () {
                window.location.href = '<?php echo base_url() ?>c_ppu/ipr';
            });
        });
    ...
    function save_ipr() {
        ...
        $.post('<?php echo base_url() ?>c_ppu/ipr/save', data, function (r) {
            if (r.success) {
                window.location.href = '<?php echo base_url() ?>c_ppu/ipr';
            }
        }, 'json');
    ...
    function edit_ipr(el) {

        $.post('<?php echo base_url() ?>c_ppu/ipr/getIpr', {
            id_ipr: el
        }, function (r) {
            if (r) {
                ...
                $('#kualifikasi').val(r.data.kualifikasi);
                ...
                $('#tgl_tetap_pajak').val(r.data.tgl_tetap_pajak);
                $('#tgl_pajak_daerah').val(r.data.tgl_pajak_daerah);
                $('#jenis_reklame').val(r.data.jenis_reklame);
                $('#judul_reklame').val(r.data.judul_reklame);
                $('#ukuran').val(r.data.ukuran);
                $('#banyak').val(r.data.banyak);
                $('#lokasi').val(r.data.lokasi);
    ...
    function remove_ipr(el) {
        $.post('<?php echo base_url() ?>c_ppu/ipr/delete', {
            id_ipr: el
        }, function () {
            window.location.href = '<?php echo base_url() ?>c_ppu/ipr';
        }, 'json');
                ...
                <div class="box-body table-responsive">
                    <div id="panel_list" class="panel panel-default">
                        <div class="panel-heading">
                            <a href="#" id="create_ipr" class="btn btn-info" onclick="create_ipr()"><i class="fa fa-plus-square fa"></i></a>
                        ...
                        <div class="panel-body">
                            <div style="text-align: center"><h3>Izin Pemasangan Reklame</h3></div>
                            <div class="show_message"></div>
                            <table id="ipr_table" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    foreach ($listIpr as $r) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-info" type="button" id="edit_ipr" onclick="edit_ipr(<?php echo $r['id_ipr'] ?>)"><i class="fa fa-pencil"></i></button>
                                            </td>
                                            <td>
                                                <?php if ($r['status'] != 1) { ?>
                                                    <button class="btn btn-warning" type="button" id="remove_ipr" onclick="remove_ipr(<?php echo $r['id_ipr'] ?>)"><i class="fa fa-trash"></i></button>
                                                <?php } else { ?>
                                                    <div style="text-align: center">-</div>
                                                <?php } ?>
                                            </td>
                                            <!--td>
                                                <button class="btn btn-success" type="button" id="print" onclick="print_ipr(<?php echo $r['id_ipr'] ?>, '')"><i class="fa fa-print"></i></button>
                                            </td>
                                            <td>
                                                <button class="btn btn-primary" type="button" id="print" onclick="print_ipr(<?php echo $r['id_ipr'] ?>, 'doc')"><i class="fa fa-file-word-o"></i></button>
                                            </td-->
                                        </tr>
                                        <?php
                                        $i++;
                    ...
                    <div id="panel_form" class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <button class="btn btn-primary" id="save_ipr" onclick="save_ipr()"><i class="fa fa-save"></i></button>
                        </div>
                        <div class="panel-body">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4" >
                                                <select class="form-control" id="kualifikasi">
                                                    ...
                                                    <option value="2">Neon Box</option>
                                                    <option value="3">Papan Nama</option>
                                                    <option value="4">Bando</option>
                                                    <option value="5">Wall Sign</option>
                                                    <option value="6">Shop Sign</option>
                                                    <option value="7">Building Sign</option>
                                                </select>
                                            </div>
                                        </div>
                                        <br/>
                                        ...
                                        <div class="tab-content">
                                            <div id="info_perusahaan" class="tab-pane fade in active">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-2">
                                                        <label for="tgl_tetap_pajak">Tgl Ketetapan Pajak : </label>
                                                    </div>
                                                    <div class="col-lg-2">
                                                        <input type="text" class="form-control input-sm datepicker" id="tgl_tetap_pajak"/>
                                                    </div>
                                                </div>
                                                <br/>
                                                <div class="row">
                                                    <div class="col-lg-2">
                                                        <label for="tgl_pajak_daerah">Tgl Pajak Daerah : </label>
                                                    </div>
                                                    <div class="col-lg-2">
                                                        <input type="text" class="form-control input-sm datepicker" id="tgl_pajak_daerah"/>
                                                    </div>
                                                </div>
                                                <br/>
                                            ...
                                            <div id="info_lain" class="tab-pane fade">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <textarea class="form-control input-sm" id="jenis_reklame"></textarea>
                                                    </div>
                                                </div>
                                                <br/>
                                                <div class="row">
                                                    <div class="col-lg-2">
                                                        <label for="judul_reklame">Judul Reklame : </label>
                                                    </div>
                                                    <div class="col-lg-4">
                                                        <textarea class="form-control input-sm" id="judul_reklame"></textarea>
                                                    </div>
                                                </div>
                                                <br/>
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <textarea class="form-control input-sm" id="ukuran"></textarea>
                                                    </div>
                                                </div>
                                                <br/>
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <input type="text" class="form-control input-sm" id="banyak"/>
                                                    </div>
                                                </div>
                                                <br/>
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <textarea class="form-control input-sm" id="lokasi"></textarea>
                                                    </div>
                                                </div>
                                                <br/>
                                            </div>
