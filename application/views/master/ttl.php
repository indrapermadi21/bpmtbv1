<script type="text/javascript">
    ...
    function save_menu() {
        ...
        $.post('<?php echo base_url() ?>master/ttl/saved', data, function (r) {
            alert('Over Here');
            if (r.success) {
                window.location.href = '<?php echo base_url() ?>master/ttl';
            }
        }, 'json');
    }

    function edit_pegawai(el) {
        $.post('<?php echo base_url() ?>master/ttl/getPegawai', {
            nip: el
        }, function (r) {
    ...
    function remove_pegawai(el) {
        $.post('<?php echo base_url() ?>master/ttl/delete', {
            nip: el
        }, function (r) {
            if(r.success){
                window.location.href = '<?php echo base_url() ?>master/ttl';
