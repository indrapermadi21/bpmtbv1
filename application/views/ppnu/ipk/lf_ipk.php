<script type="text/javascript">
    ...
    function save_ipk() {
        ...
        var data = {
            ...
            $.post('<?php echo base_url() ?>c_ppu/ipk/save', data, function (r) {
                if (r.success) {
                    window.location.href = '<?php echo base_url() ?>c_ppu/ipk';
                }
                
            }, 'json');
    }

    function edit_ipk(el) {

        $.post('<?php echo base_url() ?>c_ppu/ipk/getSiup', {
            id_ipk: el
        }, function (r) {
            if (r) {
    ...
    function remove_ipk(el) {
        $.post('<?php echo base_url() ?>c_ppu/ipk/delete', {
            id_ipk: el
        }, function (r) {
            if(r.success){
                window.location.href = '<?php echo base_url() ?>c_ppu/ipk/';
            ...
            <div class="box">
                ...
                <div class="box-body table-responsive">
                    ...
                    <div id="panel_list" class="panel panel-default">
                        <div class="panel-heading"><a href="#" id="create_ipk" onclick="create_ipk()"><i class="fa fa-plus-square fa-2x"></i></a></div>
                        <div class="panel-body">
                            <table id="ipk_table" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                    ...
                    <div id="panel_form" class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <button class="btn btn-primary" id="save_ipk" onclick="save_ipk()"><i class="fa fa-save"></i></button>
                        </div>
                        <div class="panel-body">
                            <form id="form_ipk">
