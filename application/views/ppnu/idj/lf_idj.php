<script type="text/javascript">
    ...
    function save_idj() {
        ...
        var data = {
            ...
            $.post('<?php echo base_url() ?>c_ppu/idj/save', data, function (r) {
                if (r.success) {
                    window.location.href = '<?php echo base_url() ?>c_ppu/idj';
                }
                
            }, 'json');
    }

    function edit_idj(el) {

        $.post('<?php echo base_url() ?>c_ppu/idj/getSiup', {
            id_idj: el
        }, function (r) {
            if (r) {
    ...
    function remove_idj(el) {
        $.post('<?php echo base_url() ?>c_ppu/idj/delete', {
            id_idj: el
        }, function (r) {
            if(r.success){
                window.location.href = '<?php echo base_url() ?>c_ppu/idj/';
            ...
            <div class="box">
                ...
                <div class="box-body table-responsive">
                    ...
                    <div id="panel_list" class="panel panel-default">
                        <div class="panel-heading"><a href="#" id="create_idj" onclick="create_idj()"><i class="fa fa-plus-square fa-2x"></i></a></div>
                        <div class="panel-body">
                            <table id="idj_table" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                    ...
                    <div id="panel_form" class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <button class="btn btn-primary" id="save_idj" onclick="save_idj()"><i class="fa fa-save"></i></button>
                        </div>
                        <div class="panel-body">
                            <form id="form_idj">
