<script type="text/javascript">
    ...
    function save_ippt() {
        ...
        var data = {
            ...
            $.post('<?php echo base_url() ?>c_ppu/ippt/save', data, function (r) {
                if (r.success) {
                    window.location.href = '<?php echo base_url() ?>c_ppu/ippt';
                }
    ...
    function edit_ippt(el) {
        ...
        $.post('<?php echo base_url() ?>c_ppu/ippt/getSiup', {
            id_ippt: el
        }, function (r) {
            if (r) {
    ...
    function remove_ippt(el) {
        $.post('<?php echo base_url() ?>c_ppu/ippt/delete', {
            id_ippt: el
        }, function (r) {
            if(r.success){
                window.location.href = '<?php echo base_url() ?>c_ppu/ippt/';
                ...
                <div class="box-body table-responsive">
                    ...
                    <div id="panel_form" class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <button class="btn btn-primary" id="save_ippt" onclick="save_ippt()"><i class="fa fa-save"></i></button>
                        </div>
                        <div class="panel-body">
                            <form id="form_ippt">
                                        ...
                                        <div class="tab-content">
                                            <div id="info_perusahaan" class="tab-pane fade in active">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-4">
                                                        <textarea class="form-control input-sm" id="peruntukan"></textarea>
                                                    </div>
                                                </div>
                                                <br/>
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-4">
                                                        <input type="text" class="form-control input-sm" id="luas_tanah"/>
                                                    </div>
                                                </div>
                                                <br/>   
                                            </div>
                                            <div id="info_lain" class="tab-pane fade">
                                                ...
                                                <div class="row">
                                                    <div class="col-xs-2">
                                                        <label for="nama_perusahaan">Lokasi Yang Dimohon </label>
                                                    </div>
                                                </div>
                                                <br/>
                                                <div class="row">
