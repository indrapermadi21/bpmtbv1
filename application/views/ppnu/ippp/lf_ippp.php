<script type="text/javascript">
    ...
    function create_ippp() {
        $('#form_ippp').trigger('reset');
        $('#form_status').val('add');
        $('#panel_form').show();
        $('#panel_list').hide();
    }
    ...
    function save_ippp() {
        ...
        var data = {
            ...
            $.post('<?php echo base_url() ?>c_ppu/ippp/save', data, function (r) {
                if (r.success) {
                    window.location.href = '<?php echo base_url() ?>c_ppu/ippp';
                }
                
            }, 'json');
    }

    function edit_ippp(el) {

        $.post('<?php echo base_url() ?>c_ppu/ippp/getSiup', {
            id_ippp: el
        }, function (r) {
            if (r) {
    ...
    function remove_ippp(el) {
        $.post('<?php echo base_url() ?>c_ppu/ippp/delete', {
            id_ippp: el
        }, function (r) {
            if(r.success){
                window.location.href = '<?php echo base_url() ?>c_ppu/ippp/';
            ...
            <div class="box">
                ...
                <div class="box-body table-responsive">
                    ...
                    <div id="panel_list" class="panel panel-default">
                        <div class="panel-heading"><a href="#" id="create_ippp" onclick="create_ippp()"><i class="fa fa-plus-square fa-2x"></i></a></div>
                        <div class="panel-body">
                            <table id="ippp_table" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                    ...
                    <div id="panel_form" class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <button class="btn btn-primary" id="save_ippp" onclick="save_ippp()"><i class="fa fa-save"></i></button>
                        </div>
                        <div class="panel-body">
                            <form id="form_ippp">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div id="info_lain" class="tab-pane fade">
                                                ...
                                                <div class="row">
                                                    <div class="col-xs-2">
                                                        <label for="jenis_kegiatan_kursus">Jenis Kegiatan Kursus : </label>
                                                    </div>
                                                    <div class="col-xs-4">
                                                        <textarea class="form-control input-sm" id="jenis_kegiatan_kursus"></textarea>
                                                    </div>
                                                </div>
                                                <br/>
                                            </div>
